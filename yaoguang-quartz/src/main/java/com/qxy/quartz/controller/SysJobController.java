...
import com.qxy.common.exception.job.TaskException;
import com.qxy.common.utils.common.StringUtils;
import com.qxy.quartz.domain.SysJob;
import com.qxy.quartz.service.ISysJobService;
import com.qxy.quartz.util.CronUtils;
import com.qxy.quartz.util.ScheduleUtils;
...
public class SysJobController extends BaseController {
     ...
     * 新增定时任务
     */
    @PreAuthorize("@per.hasPermission('monitor:job:add')")
     ...
     * 修改定时任务
     */
    @PreAuthorize("@per.hasPermission('monitor:job:edit')")
     ...
     * 定时任务状态修改
     */
    @PreAuthorize("@per.hasPermission('monitor:job:changeStatus')")
    @Log(title = "定时任务", businessType = BusinessType.UPDATE)
