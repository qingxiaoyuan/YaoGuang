...
import com.qxy.common.core.domain.TreeSelect;
...
import com.qxy.system.domain.vo.MetaVo;
import com.qxy.system.domain.vo.RouterVo;
import com.qxy.system.mapper.SysMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    public List<RouterVo> buildMenus(List<SysMenu> menus) {
        ...
        for (SysMenu menu : menus) {
            //  隐藏/停用的菜单不返回
            if ("1".equals(menu.getVisible()) || "1".equals(menu.getStatus())) {
                continue;
            }
            RouterVo router = new RouterVo();
            router.setName(menu.getMenuName());
            router.setPath(getRouteName(menu));
